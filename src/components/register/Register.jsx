...
export function ComponentRegister() {
  ...
  return (
    <motion.div
      ...
      className={`sm:px-3 sm-max:px-3 flex sm:flex-col-reverse sm-max:flex-col-reverse lg:flex-row w-[100vw] h-[100vh] lg:p-10 justify-center items-center xl:gap-10 overflow-auto 3xl:w-[2026px] 3xl:mx-auto ${
